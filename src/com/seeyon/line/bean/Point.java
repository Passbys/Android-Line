package com.seeyon.line.bean;

import android.widget.ImageView;

import com.seeyon.line.R;
...
public class Point {
	...
	public void setHighLighted(boolean highLighted) {
		...
		if (highLighted) {
			this.image
					.setBackgroundResource(R.drawable.line_gesture_node_highlighted);
		} else {
			this.image.setBackgroundResource(R.drawable.line_gesture_node_normal);
		}
	}
