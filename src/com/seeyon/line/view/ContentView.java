...
import com.seeyon.line.ScreenUtils;
import com.seeyon.line.bean.Point;
...
public class ContentView extends ViewGroup {
	...
	private void addChild(){
		for (int i = 0; i < 9; i++) {
			...
			image.setBackgroundResource(R.drawable.line_gesture_node_normal);
			this.addView(image);
